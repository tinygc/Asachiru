...
- 郵便番号による地域設定
- **時間帯別背景グラデーション**（早朝/昼/夕方/夜で自動切り替え、スムーズに遷移）

### 📰 ニュース読み上げ機能
- **複数RSS選択対応**: プリセットまたはカスタムURLから複数のRSSフィードを選択可能
- ユーザーが選択した複数のRSSフィードから最大10件を取得し、古い順（昇順）に自動読み上げ
