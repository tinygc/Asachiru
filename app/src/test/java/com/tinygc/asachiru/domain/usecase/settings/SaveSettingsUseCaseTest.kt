...
class SaveSettingsUseCaseTest {
    ...
    fun `invoke should validate postal code format - must be 7 digits`() = runTest {
        ...
        val invalidCodes = listOf(
            Settings("", 30, "https://test.com/rss", false, true, null),           // Empty
            Settings("123", 30, "https://test.com/rss", false, true, null),        // Too short
            Settings("12345678", 30, "https://test.com/rss", false, true, null),   // Too long
            Settings("12345ab", 30, "https://test.com/rss", false, true, null),    // Contains letters
            Settings("123-4567", 30, "https://test.com/rss", false, true, null)    // Contains hyphen
        )
    ...
    fun `invoke should validate news interval range - must be 1 to 60`() = runTest {
        ...
        val invalidIntervals = listOf(
            Settings("1000001", 0, "https://test.com/rss", false, true, null),      // Too low
            Settings("1000001", -1, "https://test.com/rss", false, true, null),     // Negative
            Settings("1000001", 61, "https://test.com/rss", false, true, null),     // Too high
            Settings("1000001", 100, "https://test.com/rss", false, true, null),    // Way too high
            Settings("1000001", 1000, "https://test.com/rss", false, true, null)    // Extremely high
        )
    ...
    fun `invoke should accept valid settings with boundary values`() = runTest {
        ...
        val boundarySettings = listOf(
            Settings("0000000", 1, "https://test.com/rss", false, true, null),     // Min interval
            Settings("9999999", 60, "https://test.com/rss", false, true, null),    // Max interval
            Settings("1234567", 30, "https://test.com/rss", false, true, null)     // Middle values
        )
